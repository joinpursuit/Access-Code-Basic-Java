...
public class Simulation {
	...
	public Simulation() {
		...
		System.out.printf(fmt, "Mean service time:", (int)MEAN_SERVICE_TIME);
		System.out.printf(fmt, "Mean interarrival time:", (int)MEAN_ARRIVAL_TIME);
		...
		for (int i = 0; i < SERVERS; i++) {
			...
			System.out.printf("Mean service time for %s: %4.1f%n", servers[i],
					servers[i].getMeanServiceTime());
